...
create table bugs_import.bugs_trace (
  ...
  translated_compressed_data varchar,
...
(
	...
	authors character varying DEFAULT NULL,
	bugs_reference varchar(60) DEFAULT NULL,
	title character varying,
  full_reference character varying, --DEFAULT '' not null
  -- doi varchar(255),
  -- isbn varchar(128),
  -- notes text,
  -- year varchar(255),
...
create table tbl_sites (
  ...
  site_location_accuracy longvarchar,
  date_updated timestamp DEFAULT current_timestamp(),
...
CREATE TABLE tbl_sample_group_sampling_contexts (
  ...
  sampling_context varchar(80) NOT NULL,
  description longvarchar,
...
(
  ...
  REFERENCES tbl_dating_uncertainty (dating_uncertainty_id),
  CONSTRAINT fk_relative_dates_analysis_entity FOREIGN KEY (analysis_entity_id)
  REFERENCES tbl_analysis_entities (analysis_entity_id),
...
--   CONSTRAINT fk_abundances_abundance_element_id FOREIGN KEY (abundance_element_id) REFERENCES tbl_abundance_elements (abundance_element_id),
  CONSTRAINT fk_abundances_analysis_entity_id FOREIGN KEY (analysis_entity_id) REFERENCES tbl_analysis_entities (analysis_entity_id),
  CONSTRAINT fk_abundances_taxon_id FOREIGN KEY (taxon_id) REFERENCES tbl_taxa_tree_master (taxon_id)
);
