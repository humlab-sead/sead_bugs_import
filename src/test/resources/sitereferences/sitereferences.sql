...
insert into tbl_biblio (biblio_id, authors, bugs_reference, title) values (1, 'Robinson, M. A.  (1979)','Robinson (1979b)','Calcified seeds and arthopods.  In M. Parrington, Excavations at Stert Street, Abingdon, Oxon.  Oxoniensia, 44, 23-24.');
insert into tbl_biblio (biblio_id, authors, bugs_reference, title) values (3, 'Lemdahl, G. & Nilsson, A., (1982)','Lemdahl & Nilsson (1982)','Ett postglacialt subfossilfynd av dykarbaggen Cybister lateralimarginalis från Skane. Entomologisk Tidskrift, 103, 121-122.');
insert into tbl_biblio (biblio_id, authors, bugs_reference, title) values (4, 'Lemdahl, G.  (1983)','Lemdahl (1983)','Beetle remains from the Refuse Layer of the Bog Site Ageröd V. Appendix V, In L. Larsson (ed.) Ageröd V, an inland bogsite from the Atlantic period.  Acta Archaeologica Lundensia, 8° ser., 12, 169-172.');
insert into tbl_biblio (biblio_id, authors, bugs_reference, title) values (5, 'McCabe, A.M., Coope, G. R., Gennard, D. E. & Doughty, P. (1987)','McCabe et al. (1987)','Freshwater organic deposits and stratified sediments between Early and Late Midlandian (Devensian) till sheets at Aghnadarragh, County Antrim, Northern Ireland. Journal of Quaternary Science, 2, 11-34.');
insert into tbl_biblio (biblio_id, authors, bugs_reference, title) values (6, 'Panagiotakopulu, E. (2000)','Panagiotakopulu (2000)','Archaeology and entomology in the eastern Mediterranean. Research into the history of insect synanthropy in Greece and Egypt. British Archaeological Reports International Series 836. Oxford.');
insert into tbl_biblio (biblio_id, authors, bugs_reference, title) values (7, 'Panagiotakopulu, E. & Buckland, P.C. (1991)','Panagiotakopulu & Buckland (1991)','Insect pests of stored products from Late Bronze Age Santorini, Greece. Journal of stored Product Research, 27, 179-184.');
insert into tbl_biblio (biblio_id, authors, bugs_reference, title) values (8, 'Panagiotakopulu, E., Buckland, P. C., Day, P., Doumas, C., Sarpali, A. & Skidmore, P. (1997)','Panagiotakopulu et al. (1997)','A lepidopterous cocoon from Thera and evidence for silk in the Aegean Bronze Age. Antiquity, 71, 420-429.');
insert into tbl_biblio (biblio_id, authors, bugs_reference, title) values (9, 'Shotton, F. W. Osborne, P. J. & Greig, J. R. A.  (1977)','Shotton et al. (1977)','The fossil content of a Flandrian deposit at Alcester.  Proceedings of the Coventry and District Natural History and Scientific Society, 5, 19-32.');
