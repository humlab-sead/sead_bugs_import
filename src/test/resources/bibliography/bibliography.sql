insert into tbl_biblio (biblio_id, authors, bugs_reference, title, full_reference)
    values (1, 'Exists, A.B (2000)', 'Exists 2000', 'An existing bibliography non-edited', 'Exists, A.B (2000) An existing bibliography non-edited');
...
insert into tbl_biblio (biblio_id, authors, bugs_reference, title, full_reference, date_updated)
    values (2, 'Exists, A.B (2001)', 'Exists 2001', 'A changed entry', 'Exists, A.B (2001) A changed entry', '2016-01-01');
...
insert into tbl_biblio (biblio_id, authors, bugs_reference, title, full_reference)
values (3, 'Exists, A.B (2012)', 'Exists 2012', 'A preinstalled bugs reference', 'Exists, A.B (2012) A preinstalled bugs reference');