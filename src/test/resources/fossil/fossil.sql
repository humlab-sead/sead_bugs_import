...
insert into tbl_taxa_tree_master (taxon_id, species, genus_id, author_id) values (3, 'sp.', 2, null);
...
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, translated_compressed_data, bugs_identifier, sead_table, sead_reference_id)
values (3, 'TCountsheet', '{COUN000002,No sheet type match,SITE000001,Archaeological contexts,Presence/Absence}', '{COUN000002,No sheet type match,SITE000001,Archaeological contexts,Presence/Absence}', 'COUN000002', 'tbl_sample_groups', 2);
...
insert into tbl_sample_groups (sample_group_id, site_id, sampling_context_id, method_id, sample_group_name)
values (4, 1, 1, 1, 'Appended dataset');
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, translated_compressed_data, bugs_identifier, sead_table, sead_reference_id)
values (5, 'TCountsheet', '{COUN000004,Appended dataset,SITE000001,Archaeological contexts,Presence/Absence}', '{COUN000004,Appended dataset,SITE000001,Archaeological contexts,Presence/Absence}', 'COUN000003', 'tbl_sample_groups', 4);
...
values (1, 1, 1, 1, '');
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
values (6, 'TSample', '', 'SAMP000001', 'tbl_physical_samples', 1);

insert into tbl_physical_samples (physical_sample_id, sample_group_id, alt_ref_type_id, sample_type_id, sample_name)
values (2, 2, 1, 1, '');
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
values (7, 'TSample', '', 'SAMP000002', 'tbl_physical_samples', 2);

insert into tbl_physical_samples (physical_sample_id, sample_group_id, alt_ref_type_id, sample_type_id, sample_name)
values (3, 3, 1, 1, '');
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
values (8, 'TSample', '', 'SAMP000003', 'tbl_physical_samples', 3);

insert into tbl_physical_samples (physical_sample_id, sample_group_id, alt_ref_type_id, sample_type_id, sample_name)
values (4, 4, 1, 1, '');
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
values (9, 'TSample', '', 'SAMP000004', 'tbl_physical_samples', 4);
...
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (10, 'TFossil', null, 'FOSI000001', 'tbl_datasets', 1);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (11, 'TFossil', null, 'FOSI000001', 'tbl_analysis_entities', 1);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (12, 'TFossil', null, 'FOSI000001', 'tbl_abundances', 1);
...
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (13, 'TFossil', null, 'FOSI000002', 'tbl_datasets', 2);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (14, 'TFossil', null, 'FOSI000002', 'tbl_analysis_entities', 2);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (15, 'TFossil', null, 'FOSI000002', 'tbl_abundances', 2);

insert into tbl_abundances (abundance_id, taxon_id, analysis_entity_id, abundance) values (3, 2, 2, 1);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (16, 'TFossil', null, 'FOSI000003', 'tbl_abundances', 3);

insert into tbl_datasets (dataset_id, master_set_id, method_id, data_type_id, dataset_name) values (3, 1, 3, 1, 'COUN000004');
insert into tbl_analysis_entities (analysis_entity_id, physical_sample_id, dataset_id) values (3, 4, 3);
insert into tbl_abundances (abundance_id, taxon_id, analysis_entity_id, abundance) values (4, 1, 3, 1);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (17, 'TFossil', null, 'FOSI000006', 'tbl_datasets', 3);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (18, 'TFossil', null, 'FOSI000006', 'tbl_analysis_entities', 3);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (19, 'TFossil', null, 'FOSI000006', 'tbl_abundances', 4);
insert into tbl_abundances (abundance_id, taxon_id, analysis_entity_id, abundance) values (5, 2, 3, 1);
insert into bugs_import.bugs_trace (bugs_trace_id, bugs_table, bugs_data, bugs_identifier, sead_table, sead_reference_id)
    values (20, 'TFossil', null, 'FOSI000007', 'tbl_abundances', 5);
