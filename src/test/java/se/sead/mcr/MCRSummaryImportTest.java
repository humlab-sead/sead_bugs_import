...
public class MCRSummaryImportTest {
    ...
    private void verifyTraces() {
        for (MCRSummaryData bugsData :
            ...
            List<BugsTrace> traces = traceRepository.findByBugsTableAndAccessInformationData("TMCRSummaryData", bugsData.getCompressedStringBeforeTranslation());
    ...
    private void verifyErrors() {
        for (MCRSummaryData bugsData:
                MCRSummarTestDefinition.EXPECTED_BUGS_DATA){
            List<BugsError> errors = errorRepository.findByBugsTableAndAccessInformationData("TMCRSummaryData", bugsData.getCompressedStringBeforeTranslation());
