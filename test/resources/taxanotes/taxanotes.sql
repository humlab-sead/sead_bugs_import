...
insert into tbl_taxonomy_notes (taxonomy_notes_id, biblio_id, taxon_id, taxonomy_notes) values (1, 1, 1, 'Note exists');
insert into bugs_import.bugs_trace(bugs_trace_id, bugs_table, bugs_data, sead_table, sead_reference_id)
    values (1, 'TTaxoNotes', '{1.0,Ref 1,Note exists}', 'tbl_taxonomy_notes', 1);
