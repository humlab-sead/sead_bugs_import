...
drop table if exists tbl_site_locations;
drop table if exists tbl_site_other_records;
drop table if exists tbl_record_types;
drop table if exists tbl_site_references;
drop table if exists tbl_sample_group_sampling_contexts;
drop table if exists tbl_units;
drop table if exists tbl_method_groups;
drop table if EXISTS tbl_units;
drop table if exists tbl_taxa_seasonality;
drop table if exists tbl_seasons;
drop table if exists tbl_activity_types;
drop table if exists tbl_ecocode_definitions;drop table if exists tbl_ecocode_groups;
drop table if exists tbl_ecocode_systems;
drop table if exists tbl_rdb_systems;
drop table if exists tbl_rdb_codes;
drop table if exists tbl_rdb;
drop table if exists tbl_mcr_names;
drop table if exists tbl_taxa_measured_attributes;
