...
@SpringApplicationConfiguration({Application.class, SiteReferencesImportTest.Config.class})
@ActiveProfiles("test")
...
public class SiteReferencesImportTest {
    ...
    public static class Config extends DefaultConfig {
        ...
        public Config(){
            super("sitereferences", "sitereferences.mdb", "sitereferences.sql");
        }

        @Bean
        @Override
        public AccessReaderProvider getDatabaseReader() {return new DefaultAccessDatabaseReader(getMdbFile());}
