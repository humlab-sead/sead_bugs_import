...
public interface BugsTraceRepository extends Repository<BugsTrace, Integer> {
    ...
    List<BugsTrace> findByBugsTableAndAccessInformationIgnoreCaseData(String bugsTable, String accessInformationData);
    ...
    List<BugsTrace> findByBugsTableAndBugsIdentifierIgnoreCaseOrderByChangeDate(String bugsTable, String bugsIdentifier);
    ...
    List<BugsTrace> findByBugsTableAndSeadTableAndAccessInformationIgnoreCaseDataOrderByChangeDate(String bugsTable, String seadTable, String accessInformationData);
    ...
    List<BugsTrace> findByBugsTableAndSeadTableAndBugsIdentifierIgnoreCaseOrderByChangeDate(String bugsTable, String seadTable, String bugsIdentifier);
